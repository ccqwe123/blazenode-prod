...
const ReferralsContent = () => {
    ...
    <ReferralTier currentReferrals={confirmed} onTierChange={handleTierChange} className={`border border-zinc-900 mb-6`} />
        <div className="w-full h-auto mx-auto p-6 rounded-[20px] border border-[#1e1e1e]">
            <h2 className="text-[20px] font-semibold mb-6">Invite friends to earn more points</h2>
            <div className="flex flex-col md:flex-row md:space-x-6 space-y-4 md:space-y-0 items-stretch">
                <div className="flex items-start space-x-4 flex-1 border border-[#1e1e1e] rounded-[16px] px-6 py-5">
                    <div className="pt-1 text-[#9ca3af]">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87M16 3.13a4 4 0 010 7.75M8 3.13a4 4 0 010 7.75M12 14a4 4 0 00-4 4v1h8v-1a4 4 0 00-4-4z" />
                        </svg>
                    </div>
                    <div>
                        <h3 className="text-[15px] font-semibold mb-1">Refer your friends</h3>
                        <p className="text-[13px] text-[#9ca3af] leading-tight">Start referring friends with your referral code.</p>
                        <p className="text-[13px] text-[#9ca3af] leading-tight">You will earn a reward with every rank up</p>
                    </div>
                </div>
                <div className="flex justify-center md:items-center text-[#9ca3af]">
                    <ArrowRight className="h-7 w-7 rotate-90 md:rotate-0" />
                </div>
                <div className="flex-1 border border-zinc-800 rounded-[16px] px-6 py-5">
                    <h3 className="text-[15px] font-semibold mb-1">Earn when friends sign up</h3>
                    <p className="text-[13px] text-[#9ca3af] leading-tight">Your referral will become confirmed once your referee achieves 72 hours of uptime.</p>
                    <p className="text-[13px] text-[#9ca3af] leading-tight">When your referral is confirmed, you will receive a 1% bonus of each node's referral earnings</p>
                </div>
            </div>
        </div>
    </>
